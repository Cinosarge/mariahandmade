/**
 * Invia una richiesta GET verso la risora dbManager.do che fa capo alla servlet ManagerServlet
 * e gestisce il database. E' atteso un messaggio di risposta dal server
 * con questa forma
 * 
 * <notification>
 ...
 * dell'operazione.
 */
function manageDatabase(operation) {
	...
	request.open("GET", "manageDatabase.do?operation=" + operation, true);
	request.send(null);
}
