/**
 * Invia una richiesta GET verso la risora deleteProduct.do che fa capo alla servlet DeleteProduct.
 ...
 * dell'operazione.
 */
function markProductAsDeleted(productCode) {
	...
	request.open("GET", "deleteProduct.do?productCode=" + productCode, true);
	request.send(null);
}
